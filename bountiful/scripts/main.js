...
function populateSelect() {
  ...
  for (let i = 0; i < fruit.length; i++) {
    ...
    ele1.innerHTML = ele1.innerHTML +
      '<option value="' + fruit[i]['id'] + '">' + fruit[i]['name'] + '</option>';
  }
...
formElement.addEventListener("submit", function(e) {
  ...
  feedbackElement.innerHTML =
    `Thanks for your order, ${user_name}! We have you down at ${user_email}. We're showing you have special instructions as "${user_message}". 
    You chose fruit 1 as ${fruit1}, fruit 2 as ${fruit2}, and fruit 3 as ${fruit3}. We're on it!`;
